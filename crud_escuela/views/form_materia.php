...
<!----------------aqui va codigo externo---->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="container">
  <form action="../controlator/guardar_materia.php" method="POST">

    <label for="fname">Nombre de Materia</label>
    <input type="text" id="fname" name="nombre_materia" placeholder="Ingresa nombre de la materia.." required>

    <label for="exampleFormControlTextarea1" class="form-label">Descripcion de la materia</label>
    <textarea class="form-control" name="descripcion_materia" id="exampleFormControlTextarea1" rows="3"></textarea>

    <label for="fname">Horas de Materia</label>
    <input type="text" id="fname" name="horas_materia" placeholder="Ingresa las horas de la materia.." required>
