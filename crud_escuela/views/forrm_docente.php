...
<!----------------aqui va codigo externo---->
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="container">
  <form action="../controlator/guardar_docente.php" method="POST">

    <label for="fname">Numero de empleado</label>
    <input type="text" id="fname" name="numero_empleado" placeholder="Ingresa numero de empreado de docente.." required>

    <label for="fname">Nombre de Docente</label>
    <input type="text" id="fname" name="nombre_docente" placeholder="Ingresa nombre de docente.." required>

    <label for="lemail">Correo del docente</label>
    <input type="email" id="lemail" name="email_docente" placeholder="Ingresa email de docente.." required>

    <label for="perfil">Perfil docente</label>
    <select id="perfil" name="perfil_docente" required>
    ...
    <input type="text" id="fname" name="direccion_docente" placeholder="Ingresa dirección de docente.." required>

    <label for="telefono">Telefono del Docente</label>
    <input type="text" id="fname" name="telefono_docente" placeholder="Ingresa telefono de docente.." required>
